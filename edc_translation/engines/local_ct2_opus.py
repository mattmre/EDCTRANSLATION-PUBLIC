"""Optional CTranslate2-backed OPUS-MT engine adapter."""
...
MODEL_DIR_ENV = "EDC_TRANSLATION_LOCAL_CT2_OPUS_MODEL_DIR"


@register_engine
class LocalCT2OpusEngine(CT2SentencePieceEngine):
    """OPUS-MT adapter scaffold backed by optional CTranslate2 runtime."""
